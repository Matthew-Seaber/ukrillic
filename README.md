...
## Key features
- Transliterate Latin to Cyrillic instantly, with multiple word possibilities for ease of use
- Intuitively designed page: typing when not focused on an input will automatically focus the input field, and a range of keybinds are available for efficient transliteration

## Live demo
👉 [Ukrillic website](https://ukrillic.vercel.app/) (hosted on Vercel using Next.js)